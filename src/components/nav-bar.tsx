...
const NavBarUser = async () => {
  ...
  if (user) {
    ...
    return (
      <Button
        asChild
        className="mx-4 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
      >
